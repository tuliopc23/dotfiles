...
nmap_leader('fz', '<Cmd>Pick zoxide<CR>',                       'Zoxide')

-- LazyVim-like "Power Mappings"
nmap_leader(' ', '<Cmd>Pick files<CR>',                         'Find Files (Smart)')
nmap_leader(',', '<Cmd>Pick buffers<CR>',                       'Switch Buffer')
nmap_leader('/', '<Cmd>Pick grep_live<CR>',                     'Grep (Root)')
nmap_leader('e', '<Cmd>lua MiniFiles.open()<CR>',               'Explorer (Root)')

-- Jump (Flash-like)
vim.keymap.set({ 'n', 'x', 'o' }, 's', '<Cmd>lua MiniJump2d.start(MiniJump2d.builtin_opts.single_character)<CR>', { desc = 'Jump' })
